...
const DetailBook = () => {
  ...
  return (
    <Layout>
      <Card className="bg-neutral-100 text-black dark:bg-rose-700 dark:text-white border-rose-500 shadow-md shadow-rose-600 dark:shadow-rose-500">
        <CardContent className="flex flex-col md:flex-row gap-4 pt-6">
          ...
          <div className="flex flex-col gap-2 justify-center p-5 ">
            <div className="w-fit text-black hover:cursor-pointer">
              <Link to="/">
                <svg
            ...
            <Separator className="my-3 bg-rose-500" />
            ...
            {user ? (
              <>
                <Button
                  className={cn(
                    "w-1/6 bg-rose-600 hover:bg-rose-700",
