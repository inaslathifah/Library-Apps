...
const EditProfile = () => {
  ...
  return (
    <Layout centerX centerY>
      <Card className="w-full md:w-1/2 bg-rose-500 text-white border-rose-300">
        {data ? (
          <CardContent>
            <form className="space-y-4" onSubmit={onSubmit}>
              ...
              <div>
                ...
                <Input
                  className="bg-slate-100 border-slate-100 mt-1 text-black"
              ...
              <div>
                <Button
                  type="submit"
                  className="bg-slate-100 text-black hover:bg-rose-300 me-3"
                >
                  Submit
                </Button>
                ...
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button variant={"destructive"} className="bg-red-700 hover:bg-red-800">Delete Account</Button>
                  </AlertDialogTrigger>
                  <AlertDialogContent className="bg-rose-300 text-white border-black">
                    <AlertDialogHeader>
                      <AlertDialogTitle>
