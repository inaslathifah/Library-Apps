...
export function Cart() {
  ...
  return (
    <Sheet>
      ...
      <SheetContent className="bg-white text-black dark:bg-rose-700 border-rose-400 dark:text-white">
        <SheetHeader>
        ...
        <div className="flex flex-col gap-4 py-4 w-full overflow-auto text-white">
          {cart.map((book) => (
            <div
              className="flex gap-5 items-center shadow-md shadow-rose-300 dark:shadow-rose-600 text-black dark:text-black"
              key={book.id}
            >
              <img
